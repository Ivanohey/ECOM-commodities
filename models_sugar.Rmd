...
```{r}
saveRDS(sugar_lasso_oi, "models_pred/sugar_lasso_oi.rds")
saveRDS(sugar_lasso_MMS, "models_pred/sugar_lasso_mms.rds")
saveRDS(sugar_lasso_MML, "models_pred/sugar_lasso_mml.rds")
