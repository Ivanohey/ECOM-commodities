...
```{r}
COT_data_long <- COT_Cocoa %>%
  gather(key = "Variable", value = "Value", -Date)

ggplot(data = COT_data_long, aes(x = Date, y = Value)) +
  geom_line() +
  facet_wrap(~Variable, scales = "free_y") +
  labs(title = "Time Series Plots for COT Cocoa",
       x = "Date", y = "Value")
...
COT_Cocoa$MA <- zoo::rollmean(COT_Cocoa$`Open Interest`, k = 10, fill = NA)
plot(COT_Cocoa$Date, COT_Cocoa$MA, type = "l", xlab = "Date", ylab = "10-Day Moving Average", main = "10-Day Moving Average")
