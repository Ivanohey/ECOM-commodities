...
# Create a tsibble with regular dates starting from January 2006
regular_tsibble3 <- tsibble(date = seq(from = as.Date("2006-01-01"), by = "1 week", length.out = nrow(COT_Cotton)))

# Merge COT_Cotton and regular_tsibble based on nothing
merged_data3 <- bind_cols(COT_Cotton, regular_tsibble3)
