...
categorize_commodity <- function(commodity_name) {
  if (commodity_name %in% c("Cotton", "Coffee", "Sugar", "Cocoa", "Corn", "SoyBeans", "SoybeanOil", "SoybeanMeal", "Wheat", "LeanHogs")) {
    return("Agricultural Commodities")
  } else if (commodity_name %in% c("FeederCattle", "LiveCattle", "LeanHogs")) {
    return("Livestock")
  } else if (commodity_name %in% c("Copper", "Gold", "Silver", "Platinum", "Palladium")) {
    return("Metals")
  } else if (commodity_name %in% c("CrudeOil", "NaturalGas", "HeatingOil")) {
