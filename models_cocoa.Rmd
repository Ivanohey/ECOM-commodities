...
```{r cocoa Open Interest LASSO Regression}
saveRDS(cocoa_lasso_pred_oi, "path/to/your_model.rds")
```
...
```{r}
saveRDS(cocoa_lasso_pred_oi, "models_pred/cocoa_lasso_oi.rds")
saveRDS(cocoa_lasso_pred_MMS, "models_pred/cocoa_lasso_mms.rds")
saveRDS(cocoa_lasso_pred_MML, "models_pred/cocoa_lasso_mml.rds")
